...
export default async function OpetajaUlesandedPage() {
      ...
      <main className="max-w-4xl mx-auto w-full px-4 py-8 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <p className="text-sm text-slate-600">
            Lisa avalikku ülesannete panka töölehti ja ülesandeid, mida teised õpetajad-uurijad ja teadurid
            saavad oma tunnikavades kasutada.
          </p>
        </div>
